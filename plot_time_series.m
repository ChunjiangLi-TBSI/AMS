...
for i = 1:5
    ...
    plot(i+0.9*input(i,:), "Marker", ".", "Color",map(mod(i, 5)+1,:), "LineWidth",4)
end
hold off
...
for i = 1:5
    ...
    plot(i+circshift(0.9*output(i,:), -7000), "Marker", ".", "Color",map(mod(i, 5)+1,:), "LineWidth",4)
end
hold off
...
saveas(gcf, "time_series.tif", "tiffn")